...
export default function Four() {
    ...
    useEffect(() => {
        ...
        const choice3 = operators3[operation];
        seta(() => a);
        setb(() => b);
        setc(() => c);
        setd(() => d);
        ...
        setOp2(() => choice2);
        setOp3(() => choice3);
        const question = `${a}${choice}${b}${choice2}${c} ${choice3}${d}`
    ...
    return (
        <div className="flex flex-col lg:flex-row w-full min-h-screen">
            ...
            <div className=" text-white flex flex-col flex-wrap w-full lg:w-1/2 min-h-screen lg:h-screen justify-center items-center border-2 border-amber-300 bg-black p-4">
                <div className='flex flex-col flex-wrap justify-center items-center border-2 border-amber-300 rounded lg:w-120  lg:h-64 sm:w-80 sm:h-80 gap-y-6 w-70 h-64 sm:gap-y-10'>
                    <div className='flex flex-wrap bg-sky-400 p-2 rounded items-center text-xl sm:text-2xl gap-4 sm:gap-x-10 lg:gap-x-10 '>
                        <h1 >Question : </h1>
                        <p >{a} {op} {b} {op2} {c} {op3} {d}</p>
                    </div>
                    <div className='flex flex-col w-60 h-22 lg:w-60 lg:h-25 p-2 bg-blue-600 gap-2 lg:gap-4 rounded'>
                        <input
                            value={val}
